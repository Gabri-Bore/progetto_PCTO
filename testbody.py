...
def draw_silhouette(screen, pose):
    ...
    # Disegna il contorno della sagoma umana
    pygame.draw.circle(screen, BLACK, head, 30)  # Testa
    pygame.draw.line(screen, BLACK, head, left_shoulder, 5)
    pygame.draw.line(screen, BLACK, head, right_shoulder, 5)
